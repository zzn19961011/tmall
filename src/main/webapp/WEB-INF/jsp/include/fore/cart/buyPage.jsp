        ...
        <div class="address">
            ...
            <div>
                ...
                <table class="addressTable">
                    ...
                    <tr>
                        <td>邮政编码</td>
                        <td><input  name="post" placeholder="如果您不清楚邮递区号，请填写000000" type="text"
                                    pattern="^\d{6}$" required="required" oninvalid="setCustomValidity('请输入6位邮政编码')" oninput="setCustomValidity('')"></td>
                    </tr>
                    <tr>
                        <td>收货人姓名<span class="redStar">*</span></td>
                        <td><input  name="receiver"  placeholder="长度不超过25个字符" type="text"
                                    pattern="^[\u4E00-\u9FA5A-Za-z]+$" required="required" oninvalid="setCustomValidity('请输入中文或英文')" oninput="setCustomValidity('')"></td>
                    </tr>
                    <tr>
                        <td>手机号码 <span class="redStar">*</span></td>
                        <td><input name="mobile"  placeholder="请输入11位手机号码" type="text"
                                   pattern="^1\d{10}$" required="required" oninvalid="setCustomValidity('请输入11位手机号码')" oninput="setCustomValidity('')"></td>
                    </tr>
                </table>
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        ...
                        <a class="marketLink" href="#nowhere">店铺：多帅哦</a>
