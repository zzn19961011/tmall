                ...
                <table class="editTable">
                    ...
                    <tr>
                        ...
                        <td><input id="originalPrice" value="${p.originalPrice}" name="originalPrice" type="text"
                                   class="form-control"   pattern="[1-9]\d*.\d*|0.\d*[1-9]\d*" required="required" oninvalid="setCustomValidity('请输入一个实数')" oninput="setCustomValidity('')"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                    ...
                    <tr>
                        <td>库存</td>
                        <td><input id="stock"  value="${p.stock}" name="stock" type="text" pattern="[1-9]\d*|0" required="required" oninvalid="setCustomValidity('请输入一个整数')" oninput="setCustomValidity('')"
                                   class="form-control"></td>
                    </tr>
